...
(function (ChainId) {
  ...
  ChainId[ChainId["ROBURNA"] = 156] = "ROBURNA";
  ChainId[ChainId["ROBURNA_TESTNET"] = 157] = "ROBURNA_TESTNET";
})(ChainId || (ChainId = {}));
...
var _999 = /*#__PURE__*/JSBI.BigInt(999);
...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB', 'https://www.binance.org'), _WETH[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB', 'https://www.binance.org'), _WETH[ChainId.ETHEREUM] = /*#__PURE__*/new Token(ChainId.ETHEREUM, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether', 'https://weth.io/'), _WETH[ChainId.POLYGON] = /*#__PURE__*/new Token(ChainId.POLYGON, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'WMATIC', 'Wrapped Matic', 'https://polygon.technology/'), _WETH[ChainId.ROBURNA] = /*#__PURE__*/new Token(ChainId.ROBURNA, '0x86D1D92E543220Bd2F91Ec01694100043a25675A', 18, 'WRBA', 'Wrapped Roburna', 'https://roburna.com/'), _WETH[ChainId.ROBURNA_TESTNET] = /*#__PURE__*/new Token(ChainId.ROBURNA_TESTNET, '0x38aed14869Df0B10abCE55b6de03Ae168b5c1eeF', 18, 'WRBA', 'Wrapped Roburna', 'https://roburna.com/'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, factoryAddress, initCodeHash) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(factoryAddress, initCodeHash, tokenAmounts[0].token, tokenAmounts[1].token), 18, 'Goose-lp', // used for permit
  ...
  Pair.getAddress = function getAddress(factoryAddress, initCodeHash, tokenA, tokenB) {
    var _PAIR_ADDRESS_CACHE$f, _PAIR_ADDRESS_CACHE$f2;

    var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks

    if (!(PAIR_ADDRESS_CACHE === null || PAIR_ADDRESS_CACHE === void 0 ? void 0 : PAIR_ADDRESS_CACHE[factoryAddress])) PAIR_ADDRESS_CACHE[factoryAddress] = {};

    if ((PAIR_ADDRESS_CACHE === null || PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$f = PAIR_ADDRESS_CACHE[factoryAddress]) === null || _PAIR_ADDRESS_CACHE$f === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$f2 = _PAIR_ADDRESS_CACHE$f[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$f2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$f2[tokens[1].address]) === undefined) {
      var _PAIR_ADDRESS_CACHE$f3, _extends2, _extends3;

      PAIR_ADDRESS_CACHE[factoryAddress] = _extends({}, PAIR_ADDRESS_CACHE[factoryAddress], (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE$f3 = PAIR_ADDRESS_CACHE[factoryAddress]) === null || _PAIR_ADDRESS_CACHE$f3 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$f3[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(factoryAddress, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), initCodeHash), _extends2)), _extends3));
    }
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.raw, _999);
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), _999);
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var factories = trade.route.pairs.map(function (pair) {
      return validateAndParseAddress(pair.factory);
    });
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[ChainId.MAINNET] = {}, _TOKEN_DECIMALS_CACHE[ChainId.ETHEREUM] = {
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider, factoryAddress, initCodeHash) {
    try {
      ...
      return Promise.resolve(new Contract(address, IGooseBumpsSwapPair, provider).getReserves()).then(function (_ref) {
