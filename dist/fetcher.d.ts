...
export declare abstract class Fetcher {
     ...
     */
    static fetchPairData(tokenA: Token, tokenB: Token, provider: import("@ethersproject/providers").BaseProvider | undefined, factoryAddress: string, initCodeHash: string): Promise<Pair>;
}
